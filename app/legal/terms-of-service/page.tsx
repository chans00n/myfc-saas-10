...
export const metadata = {
  title: "Terms of Service | MYFC",
  description: "Terms of service for MYFC application",
};
  ...
  return (
    <div className="container max-w-4xl mx-auto px-4 py-8 md:pt-16 md:pb-16">
      ...
      <div className="prose dark:prose-invert max-w-none">
        ...
        <p className="mb-4">
          Welcome to MYFC. These terms and conditions outline the rules and regulations for the use of our website and services.
        </p>
        <p className="mb-4">
          By accessing this website, we assume you accept these terms and conditions in full. Do not continue to use MYFC if you do not accept all of the terms and conditions stated on this page.
        </p>

        <h2 className="text-2xl font-semibold mb-4 mt-8">2. License to Use</h2>
        <p className="mb-4">
          Unless otherwise stated, MYFC and/or its licensors own the intellectual property rights for all material on the platform. All intellectual property rights are reserved.
        </p>
        <p className="mb-4">
        ...
        <ul className="list-disc pl-6 mb-4">
          ...
          <li className="mb-2">Redistribute content from MYFC (unless content is specifically made for redistribution)</li>
        </ul>
        ...
        <p className="mb-4">
          At the end of each period, your subscription will automatically renew under the exact same conditions unless you cancel it or MYFC cancels it.
        </p>
        <p className="mb-4">
        ...
        <p className="mb-4">
          In no event shall MYFC, nor its directors, employees, partners, agents, suppliers, or affiliates, be liable for any indirect, incidental, special, consequential or punitive damages, including without limitation, loss of profits, data, use, goodwill, or other intangible losses, resulting from your access to or use of or inability to access or use the service.
        </p>
