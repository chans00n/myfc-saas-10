...
-- Create the update_streak_leaderboard function
...
-- Simply drop individual policies by name
...
DROP POLICY IF EXISTS "Enable insert for service role" ON public.leaderboard_entries;
DROP POLICY IF EXISTS "Enable delete for authenticated users" ON public.leaderboard_entries;
DROP POLICY IF EXISTS "view_leaderboard" ON public.leaderboard_entries;
