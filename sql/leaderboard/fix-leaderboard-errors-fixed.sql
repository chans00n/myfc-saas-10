...
-- First get the streak category ID
DO $$
DECLARE 
...
BEGIN
  ...
  -- Output the category ID as a notice (helpful for troubleshooting)
  RAISE NOTICE 'Streak category ID: %', streak_category_id;
END $$;

-- Create the update_streak_leaderboard function separately
-- Note: You'll need to replace 'STREAK_CATEGORY_ID_HERE' manually with the ID from the NOTICE above
