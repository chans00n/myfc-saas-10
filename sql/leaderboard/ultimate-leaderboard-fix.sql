...
-- Total Workouts Leaderboard Function with completely different parameter name
CREATE OR REPLACE FUNCTION public.calculate_total_workouts_leaderboard(input_category_id UUID)
RETURNS void AS $$
BEGIN
...
-- Weekly Workouts Leaderboard Function with completely different parameter name
CREATE OR REPLACE FUNCTION public.calculate_weekly_workouts_leaderboard(input_category_id UUID)
RETURNS void AS $$
DECLARE
...
-- Monthly Workouts Leaderboard Function with completely different parameter name
CREATE OR REPLACE FUNCTION public.calculate_monthly_workouts_leaderboard(input_category_id UUID)
RETURNS void AS $$
DECLARE
