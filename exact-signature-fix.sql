...
-- Total Workouts Leaderboard Function with exact signature from error message
CREATE OR REPLACE FUNCTION public.calculate_total_workouts_leaderboard(category_id UUID)
RETURNS void AS $$
DECLARE
  p_category_id ALIAS FOR category_id;
BEGIN
...
-- Weekly Workouts Leaderboard Function with exact signature from error message
...
-- Monthly Workouts Leaderboard Function with exact signature from error message
